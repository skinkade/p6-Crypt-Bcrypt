module ext::LibraryMake;

# This is included here to try and fix a problem with the smoke tester
# not being able to find LibraryMake during build time
# this is copied from https://github.com/retupmoca/P6-LibraryMake commit 373c700
# and is redistributed with Crypt::Bcrypt under the terms of the MIT licence
# https://github.com/retupmoca/P6-LibraryMake/blob/master/LICENSE
